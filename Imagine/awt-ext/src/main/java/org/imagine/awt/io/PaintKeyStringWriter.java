 ...
 * @author Tim Boudreau
 */
final class PaintKeyStringWriter implements PaintKeyWriter<String> {

    private final StringBuilder sb;
    static final byte INT_ARRAY_PREFIX = (byte) 'i';
    static final byte BYTE_ARRAY_PREFIX = (byte) 'b';
    static final byte LONG_ARRAY_PREFIX = (byte) 'l';

    static final byte MAGIC_1 = (byte) 'k';
    static final byte MAGIC_2 = (byte) '!';

    PaintKeyStringWriter(StringBuilder sb) {
        this(sb, MAGIC_1, MAGIC_2);
    }

    PaintKeyStringWriter(StringBuilder sb, byte magic1, byte magic2) {
        this.sb = sb;
        writeByte(magic1);
        writeByte(magic2);
    }

    public PaintKeyStringWriter() {
    ...
    @Override
    public PaintKeyWriter writeInt(int value) {
    ...
    @Override
    public PaintKeyWriter writeLong(long value) {
        int oldLength = sb.length();
    ...
    @Override
    public PaintKeyWriter writeIntArray(int[] ints) {
    ...
    @Override
    public PaintKeyWriter writeLongArray(long[] ints) {
    ...
    @Override
    public PaintKeyWriter writeByte(byte b) {
    ...
    @Override
    public PaintKeyWriter writeByteArray(byte[] bytes) {
