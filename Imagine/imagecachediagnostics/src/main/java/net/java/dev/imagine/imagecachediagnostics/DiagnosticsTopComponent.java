...
@TopComponent.Description(preferredID = "DiagnosticsTopComponent",
//iconBase="SET/PATH/TO/ICON/HERE", 
persistenceType = TopComponent.PERSISTENCE_ALWAYS)
@TopComponent.Registration(mode = "properties", openAtStartup = false)
@ActionID(category = "Window", id = "net.java.dev.imagine.imagecachediagnostics.DiagnosticsTopComponent")
@ActionReference(path = "Menu/Window" /*, position = 333 */)
@TopComponent.OpenActionRegistration(displayName = "#CTL_DiagnosticsAction",
preferredID = "DiagnosticsTopComponent")
public final class DiagnosticsTopComponent extends TopComponent {
...
//    static final String ICON_PATH = "SET/PATH/TO/ICON/HERE";
    ...
    private DiagnosticsTopComponent() {
        initComponents();
