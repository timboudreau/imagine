 ...
 * <p/> The name of the property is specified as an enum. Enum.name() is used as
 * the preferences key; the enum's type is used for looking up the preferences
...
public abstract class ToolProperty {
    ...
    public static final <T extends Number> Property<Integer> scale(Property<T> prop) {
        return new Scaled<T>(prop);
    }

    static final class Scaled<T extends Number> implements Property<Integer>, PropertyID<Integer>, Constrained<Integer> {
