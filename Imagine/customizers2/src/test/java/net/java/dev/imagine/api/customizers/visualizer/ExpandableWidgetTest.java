...
import net.java.dev.imagine.api.customizers.ToolProperties;
    ...
    static class ExpandableImpl implements Expandable {
        ...
        public List<Widget> getWidgets(boolean expanded) {
            if (!expanded) {
                ...
                ToolProperty<Integer, E> ip = ToolProperty.createIntegerProperty(E.Width, 0, 100, 50);
                ToolProperty<Color, E> cp = ToolProperty.createColorProperty(E.Color, Color.RED);
                ToolProperty<Font, E> fp = ToolProperty.createFontProperty(E.Font);
