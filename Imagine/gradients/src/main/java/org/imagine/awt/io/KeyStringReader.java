 ...
 * @author Tim Boudreau
 */
final class KeyStringReader implements KeyReader {

    private int cursor;
    private final CharSequence seq;

    KeyStringReader(CharSequence seq) throws IOException {
        this(0, seq);
    }

    KeyStringReader(int cursor, CharSequence seq) throws IOException {
