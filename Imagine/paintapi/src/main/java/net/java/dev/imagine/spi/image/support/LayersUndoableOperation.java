 ...
 * @author Tim Boudreau
 */
final class LayersUndoableOperation implements UndoableEdit {

    private LayersState state;
    private boolean deepCopy;
    LayersState redoState = null;
    String opName = NbBundle.getMessage(LayersUndoableOperation.class, "LBL_UNKNOWN_UNDOABLE_OP");
    ...
    public void undo() throws CannotUndoException {
        redoState = new LayersState(state.getOwner().state(), deepCopy);
        state.restore();
        isRedo = true;
    }
