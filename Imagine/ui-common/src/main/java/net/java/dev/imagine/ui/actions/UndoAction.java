...
public class UndoAction extends CallableSystemAction {
    ...
    static Lookup.Result<UndoMgr> res;
    ...
    static synchronized void initializeUndoRedo() {
        ...
        res = UIContextLookupProvider.theLookup().lookupResult(UndoMgr.class);
        res.allInstances();
    ...
    /**
     * Listener on changes of selected workspace element and its changes.
     */
